...
import 'package:ecommerce_flutter/common/widgets/custom_button.dart';
import 'package:ecommerce_flutter/common/widgets/custom_textfields';
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                leading: Radio(
                  activeColor: Color.fromARGB(255, 188, 6, 6),
                  value: Auth.signup,
                  groupValue: _auth,
                  onChanged: (Auth? val) {
                    setState(() {
